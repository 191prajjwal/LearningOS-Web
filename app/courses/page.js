...
import { Plus, BookOpen, FolderOpen, Trash2, Edit2, ChevronRight, Search, Film } from "lucide-react";
                  ...
                  <div className="card-surface p-5 hover:border-strong transition-all cursor-pointer group h-full">
                    ...
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <button
                        ...
                        className="opacity-0 group-hover:opacity-100 p-1.5 rounded-lg hover:bg-red-500/15 text-muted hover:text-red-400 transition-all"
                      >
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      ...
                      <span className="text-xs font-mono font-medium" style={{ color }}>{progress}%</span>
                    </div>
